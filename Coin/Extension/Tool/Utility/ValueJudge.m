...
BOOL ESUIntVal(unsigned int *var, id obj)
{
    if (obj) {
        if ([obj isKindOfClass:[NSNumber class]]) {
            ...
            *var = [[_sharedNumberFormatter numberFromString:obj] unsignedIntValue];
            return YES;
        }
    }
    return NO;
...
BOOL ESUIntegerVal(NSUInteger *var, id obj)
{
    if (obj) {
        if ([obj isKindOfClass:[NSNumber class]]) {
            ...
            *var = [[_sharedNumberFormatter numberFromString:obj] unsignedIntegerValue];
            return YES;
        }
    }
    return NO;
...
BOOL ESLongVal(long *var, id obj)
{
    if (obj) {
        if ([obj isKindOfClass:[NSNumber class]]) {
            ...
            *var = [[_sharedNumberFormatter numberFromString:obj] longValue];
            return YES;
        }
    }
    return NO;
...
BOOL ESULongVal(unsigned long *var, id obj)
{
    if (obj) {
        if ([obj isKindOfClass:[NSNumber class]]) {
            ...
            *var = [[_sharedNumberFormatter numberFromString:obj] unsignedLongValue];
            return YES;
        }
    }
    return NO;
...
BOOL ESULongLongVal(unsigned long long *var, id obj)
{
    if (obj) {
        if ([obj isKindOfClass:[NSNumber class]]) {
            ...
            *var = [[_sharedNumberFormatter numberFromString:obj] unsignedLongLongValue];
            return YES;
        }
    }
    return NO;
