...
+ (NSString *)deviceModel
{
    ...
    if ([platform isEqualToString:@"iPhone8,4"]) return @"Phone SE (A1662/A1723/A1724)";
    if ([platform isEqualToString:@"iPhone9,1"]) return @"Phone 7";
    if ([platform isEqualToString:@"iPhone9,2"]) return @"Phone 7 Plus";
